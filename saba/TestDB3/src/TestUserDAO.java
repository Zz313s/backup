...
public void updateUserPasswordByUserPassword(String oldPassword,String newPassword){
	DBConnector db = new DBConnector();
	Connection con = db.getConnection();

	String sql ="update test_table set password=? where password=?";
	try{
		PreparedStatement ps = con.prepareStatement(sql);
